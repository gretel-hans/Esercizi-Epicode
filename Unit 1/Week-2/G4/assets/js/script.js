...
for (i = 0; i < starWarsCharacters.length; i++) {
  sommaTotale += Number(starWarsCharacters[i].mass)
}
...
*/
switch (true) {
  case (sommaTotale < 500 && sommaTotale > 0):
    console.log('Ship is under loaded');
    break;
  case (sommaTotale > 500 && sommaTotale < 700):
    console.log('Ship is half loaded');
    break;
  case (sommaTotale > 700 && sommaTotale < 900):
    console.log('Warning: Load is over 700');
    break;
  case (sommaTotale > 900 && sommaTotale < 1000):
    console.log('Critical Load: Over 900');
    break;
  case (sommaTotale > 1000):
